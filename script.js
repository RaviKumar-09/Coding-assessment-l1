        ...
        },
        {
            ...
            "category_products": [
                ...
                },
                {
                    ...
                    "second_image": "https://assets.myntassets.com/h_720,q_90,w_540/v1/assets/images/19276232/2022/8/8/c8c6a172-cd4d-4637-9071-522b32e3fe0f1659942435440-Women-Yellow-Cotton-Mandarin-Collar-Top-3841659942434972-5.jpg"
                },
                {
                    "id": "3w",
                    "title": "Orange top",
...
function showCategory(categoryName) {
    ...
    document.querySelector(`.category-button[onclick="showCategory('${categoryName}')"]`).classList.add('active');
    ...
    category.category_products.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <div class="price">₹${product.price} 
                ${product.compare_at_price ? `<span class="compare-at-price">₹${product.compare_at_price}</span>` : ''}
            </div>
            <div class="discount">${product.compare_at_price ? `You Save: ₹${product.compare_at_price - product.price}` : ''}</div>
